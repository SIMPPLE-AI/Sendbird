...
export class HomePage {
  ...
  constructor(public http:HttpClient, private events:Events, public navCtrl: NavController, private utilityService:UtilityService, private changeRef: ChangeDetectorRef, public storage:Storage, public loadingController:LoadingController) {
  }
